...
from update_semi import average_weights, local_trainer, pred_summary
...
if __name__ == '__main__':
    ...
    for fold_idx in range(5):
        ...
        c_local_dict, history_model_dict = {}, {}
        for idx in range(num_of_speakers): 
            ...
            history_model_dict[speaker_list[idx]] = None
        # copy weights
        ...
        for epoch in range(int(args.num_epochs)):
            ...
            for idx in idxs_speakers:
                ...
                true_labels = true_labels + train_result['y_true']
                history_model_dict[speaker_id] = copy.deepcopy(local_update)
            ...
            print('| dataset: {} | feature: {} | client_label: {} '.format(args.dataset, args.feature_type, str(args.client_label_rate)))
            print('-----------------------------------------------------------------------------------')
            print('-----------------------------------------------------------------------------------')
